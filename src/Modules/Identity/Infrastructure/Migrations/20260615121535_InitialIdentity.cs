    ...
    public partial class InitialIdentity : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SavedSalons", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SalaryAmount = table.Column<long>(type: "bigint", nullable: true),
                    SalaryCurrency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: true),
                    RentAmount = table.Column<long>(type: "bigint", nullable: true),
                    RentCurrency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: true),
                    RentTerms = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArtistProfiles_Tenants_TenantId",
                        column: x => x.TenantId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SalonManagerProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SalonManagerProfiles_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SalonManagerProfiles_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArtistProfiles_TenantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalonManagerProfiles_TenantId",
                table: "SalonManagerProfiles",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_SalonManagerProfiles_UserId",
                table: "SalonManagerProfiles",
                column: "UserId",
                unique: true);
