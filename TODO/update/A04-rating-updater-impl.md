# Task A04 — Implement SalonRatingUpdater 🟡

Create a NEW file.

**New file:** `src/Modules/Identity/Infrastructure/SalonRatingUpdater.cs`
...
**Done when:** the file exists and compiles. (Confirm the namespace `SalonOS.Identity.Infrastructure`
matches `IdentityDbContext`'s namespace — it does in this repo.)

**Verify (PowerShell):**
```powershell
Test-Path src\Modules\Identity\Infrastructure\SalonRatingUpdater.cs
```
Expect `True`.
